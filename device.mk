...
ifneq ($(strip $(TARGET_PRODUCT)), )
    TARGET_PRODUCT_CONF=$(shell test -d device && find device -maxdepth 4 -path '*/$(TARGET_PRODUCT)/BoardConfig.mk')
endif
ifneq ($(TARGET_PRODUCT_CONF),)
    TARGET_DEVICE_DIR ?= $(patsubst %/,%,$(dir $(TARGET_PRODUCT_CONF)))
